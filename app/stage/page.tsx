...
export default function StageSelectionPage() {
  ...
  useEffect(() => {
    ...
    const storedRole = localStorage.getItem("game_role"); // ⚡ ดึง Role ของผู้ใช้มาตรวจสอบด้วย
    ...
    // 🚨 [ROUTE GUARD]: ตรวจสอบสิทธิ์หากเป็น Admin ห้ามหลุดเข้ามาสร้างข้อมูลในหน้านี้เด็ดขาด
    if (storedRole === "admin") {
      console.log("Admin restricted from gameplay area. Redirecting to admin dashboard...");
